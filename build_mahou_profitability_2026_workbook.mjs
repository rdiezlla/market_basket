...
const detailDir = path.join(rootDir, "output", "mahou_codex_rotacion_2026_rentabilidad", "detail");
const manifestPath = path.join(detailDir, "workbook_tables_detail.json");
const workbookPath = path.join(detailDir, "excel_rentabilidad_mahou_rotacion_2026.xlsx");
...
const summaryRows = [
  ...
  ["summary_md", path.join(detailDir, "resumen_rentabilidad_2026.md")],
  ["escenarios_csv", path.join(detailDir, "tabla_escenarios_rentabilidad_2026.csv")],
  ["sensibilidad_csv", path.join(detailDir, "tabla_sensibilidad_pasillos_articulados.csv")],

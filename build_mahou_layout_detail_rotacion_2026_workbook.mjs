...
const detailDir = path.join(rootDir, "output", "mahou_codex_rotacion_2026", "detail");
const manifestPath = path.join(detailDir, "workbook_tables_detail.json");
const workbookPath = path.join(detailDir, "excel_layout_detallado_mahou_codex_rotacion_2026.xlsx");

...
const detailDir = path.join(rootDir, "output", "beneficio_layout_actual_2026");
const manifestPath = path.join(detailDir, "workbook_tables_detail.json");
const workbookPath = path.join(detailDir, "excel_beneficio_layout_actual_2026.xlsx");
...
const summaryRows = [
  ...
  ["summary_md", path.join(detailDir, "beneficio_layout_actual_2026.md")],
  ["repo_map_csv", path.join(detailDir, "tabla_repo_map.csv")],
  ["impacto_coste_csv", path.join(detailDir, "tabla_impacto_coste.csv")],

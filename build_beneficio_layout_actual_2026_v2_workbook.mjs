...
const detailDir = path.join(rootDir, "output", "beneficio_layout_actual_2026_v2");
const manifestPath = path.join(detailDir, "workbook_tables_detail.json");
const workbookPath = path.join(detailDir, "excel_beneficio_layout_actual_2026_v2.xlsx");
...
const summaryRows = [
  ...
  ["summary_md", path.join(detailDir, "beneficio_layout_actual_2026_v2.md")],
  ["repo_map_csv", path.join(detailDir, "tabla_repo_map.csv")],
  ["productividad_csv", path.join(detailDir, "tabla_productividad_actual_vs_contrafactual.csv")],
  ["recursos_csv", path.join(detailDir, "tabla_recursos_equivalentes_vs_realizables.csv")],
